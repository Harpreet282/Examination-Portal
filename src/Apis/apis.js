...
export  const getApiUrl = (endpoint) => API_BASE_URL + endpoint;
 ...
 const CREATE_EXAM =getApiUrl('/examiner/exam');
 const EXAMINER_DETAILS =getApiUrl('/examiner/exams');

export {
    LOGIN_API,SIGN_UP_API,PENDING_REQUESTS_API,APPROVED_REQUESTS_API,DECLINED_REQUESTS_API,UPDATE_REQUESTS_API,CREATE_COURSE_API,VIEW_COURSES,CREATE_STUDENT,EXAMINER_DETAILS,ADD_SUBECT,VIEW_SUBECTS,VIEW_STUDENT,CREATE_EXAM
