...
//                          <h2>Hii Admin</h2>
//                         <div className="mt-5 all-containers">
...
//       <h2 align='center'>Hii ADMIN!!</h2>
//       <div className="Account-info-text">
//         <h3 className='my-3'>Account Information</h3>
//    <div className="row mt-2">
//    <div className='col-md-6'>
//       <h5>First-Name: <span className='ml-2'>{profileData.firstName}</span></h5>
//     </div>
//     <div className='col-md-6'>
//       <h5>Last-Name: <span className='ml-2'>{profileData.lastName}</span></h5>
//     </div>
//    </div>
//    <div className="row mt-2">
//    <div className='col-md-6'>
//       <h5>Email: <span className='ml-2'>{profileData.email}</span></h5>
//     </div>
//     <div className='col-md-6'>
//       <h5>Mobile-Number: <span className='ml-2'>{profileData.mobileNumber}</span></h5>
//     </div>
//    </div>
//    <div className="row mt-2">
   
//     <div className='col-md-6'>
//       <h5>User-Type: <span className='ml-2'>{profileData.userType}</span></h5>
//     </div>
//     <div className='col-md-6'>
//       <h5>ID: <span className='ml-2'>{profileData._id}</span></h5>
//     </div>
//    </div>
//       </div>
//     </div>
